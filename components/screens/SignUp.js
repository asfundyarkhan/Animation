...
const { event ,block , cond, eq, set, startClock, stopClock, debug, timing, clockRunning, Value, Clock, interpolate ,
       ...
       return (
        ...
        <View style={styles.container}>
          ...
          <ClipPath id="clip">
            ...
            <Image
                href={require('../../assets/blueNight.png')}
                height={height + 50}
                width={width}
            ...
            <TapGestureHandler onHandlerStateChange={onCloseState}>
              <Animated.View style={{...styles.closeButton ,transform:[{rotate:concat(rotateCross ,'deg')}]}}>
